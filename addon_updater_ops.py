...
updater.addon = "implement_addon_updater"
...
#   Jump to line 980, if you want to hide the minutes/hours intervals
    ...
    updater.repo = "implement_addon_updater"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set
    updater.website = "https://github.com/BlenderDefender/implement_addon_updater/"
    ...
    updater.overwrite_patterns = [
        "*.png", "*.jpg", "README.md", "LICENSE.txt", "*.blend"]
    # updater.overwrite_patterns = []
    # other examples:
